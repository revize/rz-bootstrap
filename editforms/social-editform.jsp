...
<%@ include file="/plugins/_editforms_/includes/social-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/social-editform/tabs.jsp"%>
							    ...
							    <div role="tabpanel" class="tab-pane rz-tab-pane fade in active" id="edit-tab">
								    ...
								    <div class="edit-form-fields">
										  ...
										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    <label for="facebooklink">Facebook <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="facebooklink" placeholder="http://facebook.com/YourPage">
										  </div>								    	

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    <label for="twitterlink">Twitter <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="twitterlink" placeholder="http://twitter.com/YourPage">
										  </div>	

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    <label for="youtubelink">YouTube <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="youtubelink" placeholder="http://youtube.com/YourPage">
										  </div>	

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    <label for="instagramlink">Instagram <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="instagramlink" placeholder="http://instagram.com/YourPage">
										  </div>	
	...
	<%@ include file="/plugins/_editforms_/includes/social-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/social-editform/footer.jsp"%>