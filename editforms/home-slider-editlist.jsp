...
%><%-- #EndRZ-PageHeader --%>
<%@ include file="/plugins/_editforms_/includes/home-slider-editlist/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/home-slider-editlist/tabs.jsp"%>
									  ...
									  <div class="rz-editlist">
											<div class="table-responsive">
											  <table class="table table-bordered table-hover rz-table">
												  <thead>
													  <tr>
													    <th class="rz-image-col">Image <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="The image to be displayed click the image to view the actual size">?</span></th>
													    <th class="rz-seq-col">Seq <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round  rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="The order in which this item will be displayed">?</span></th>
													    <th class="rz-link-col">Link <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="Optional - Add a link and make this item clickable">?</span></th>
													    <th class="rz-title-col">Title <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="Title of the item">?</span></th>
													    <th class="rz-caption-col">Caption <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="Caption or subtitle">?</span></th>
													    <th class="rz-edit-col">Edit <span class="btn btn-deafult btn-sm rz-btn rz-btn-sm rz-btn-round rz-btn-tooltip" data-toggle="tooltip" data-placement="top" title="Editing options">?</span></th>
												    </tr>
												  </thead>
...
<%@ include file="/plugins/_editforms_/includes/home-slider-editlist/footer.jsp"%>