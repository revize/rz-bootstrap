...
%><%-- #EndRZ-PageHeader --%>
<%@ include file="/plugins/_editforms_/includes/banner-editlist/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/banner-editlist/tabs.jsp"%>
...
"></i></span></div>
	...
	<%@ include file="/plugins/_editforms_/includes/banner-editlist/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/banner-editlist/footer.jsp"%>