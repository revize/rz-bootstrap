...
<%@ include file="/plugins/_editforms_/includes/news-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/news-editform/tabs.jsp"%>
							  ...
							  <div class="tab-content rz-tab-content">
							    <div role="tabpanel" class="tab-pane rz-tab-pane fade in active" id="edit-tab">
								    ...
								    <div class="edit-form-fields">
										  ...
										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg rz-page-title">
										    <label for="pageTitle">News Title <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="pageTitle" placeholder="Enter title here">
										    <span class="help-block rz-help-block">This is the pages main here</span>
										  </div>

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg" id="sequence-published-group">
											  <div class="row">
												  <div class="col-sm-6">
												    <label for="sequencenumber">Sequence Number</label>
											      <input type="text" class="form-control rz-form-control" id="sequencenumber">
												    <span class="help-block rz-help-block">The order in which you want this to show up</span>									      
											    </div><!-- /.col-sm-6 -->
		
												  <div class="col-sm-6">
												    <label for="publishedsate">Published Date</label>
												    <div class="input-group form-group-lg rz-input-group rz-form-group-lg" id="expiration-group">
												      <input type="text" class="form-control datepicker-here rz-datepicker-here rz-form-control" data-timepicker="true" data-language="en" data-inputmask="'alias': 'date'" placeholder="dd/mm/yyyy HH:MM am" readonly="readonly" id="publishedsate">
												      <div class="input-group-addon rz-input-group-addon"><label for="publishedsate"><img src="../../plugins/_editforms_/images/expiration-icon.png" alt="Expiration Date"></label></div>
												    </div>
													    <span class="help-block rz-help-block">The date it was published (optional)</span>												    
											    </div><!-- /.col-sm-6 -->
										    </div><!-- /.row -->
										  </div><!-- /.form-group -->	
											...
											<div id="activation-expiration-group">									  										  	
											  <div class="row">
												  <div class="col-sm-6">
													  ...
													  <div class="form-group form-group-lg rz-form-group rz-form-group-lg revize-textarea" id="newsBrief">
													    <label for="newsBriefTextarea">News Brief <small></small></label>
													    <!-- replace with revize text editor and keep id="newsBriefTextarea" -->													    
													    <textarea class="form-control form-control" id="newsBriefTextarea" rows="20"></textarea>
													    <!-- replace with revize text editor and keep id="newsBriefTextarea" -->													    
												  ...
												  <div class="col-sm-6">
													  ...
													  <div class="form-group form-group-lg rz-form-group rz-form-group-lg revize-textarea" id="newsDetail">
													    <label for="newsDetailTextarea">News Detail <small></small></label>
													    <!-- replace with revize text editor and keep id="newsDetailTextarea" -->													    													    
													    <textarea class="form-control form-control" id="newsDetailTextarea" rows="20"></textarea>
													    <!-- replace with revize text editor and keep id="newsDetailTextarea" -->													    													    
													    <span class="help-block rz-help-block"></span>
													  </div>
...
"></i></span></div>
								    ...
								    <div id="rz-checkboxs">
										  <div class="checkbox-inline rz-checkbox-inline">
										    <label>
										      <input type="checkbox"> Check this to publish to the home page? 
										    </label>
										  </div>	
										  <div class="checkbox-inline rz-checkbox-inline">
										    <label>
										      <input type="checkbox"> Check to make this featured
										    </label>
										  </div>	
									  </div><!-- /#checkboxs -->
	...
	<%@ include file="/plugins/_editforms_/includes/news-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/news-editform/footer.jsp"%>