...
<%@ include file="/plugins/_editforms_/includes/leftnav-title-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/leftnav-title-editform/tabs.jsp"%>
							    ...
							    <div role="tabpanel" class="tab-pane rz-tab-pane fade in active" id="edit-tab">
								    ...
								    <div class="edit-form-fields">
										  ...
										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    ...
										    <input type="text" class="form-control rz-form-control" id="title" placeholder="Title here">
										  </div>

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg">
										    <label for="subtitle">Subtitle<small></small></label>
										    <input type="text" class="form-control rz-form-control" id="subtitle" placeholder="Subtitle Title here">
										  </div>
	...
	<%@ include file="/plugins/_editforms_/includes/leftnav-title-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/leftnav-title-editform/footer.jsp"%>