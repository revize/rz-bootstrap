...
<%@ include file="/plugins/_editforms_/includes/freeform-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/freeform-editform/tabs.jsp"%>
	...
	<%@ include file="/plugins/_editforms_/includes/freeform-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/freeform-editform/footer.jsp"%>