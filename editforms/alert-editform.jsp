...
<%@ include file="/plugins/_editforms_/includes/alert-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/alert-editform/tabs.jsp"%>
							  ...
							  <div class="tab-content rz-tab-content">
							    <div role="tabpanel" class="tab-pane fade in active rz-tab-pane" id="edit-tab">
								    ...
								    <div class="rz-edit-form-fields">
										  ...
										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg" id="rz-alertTitle-group">
										    <label for="alertTitle">Title <small></small></label>
										    <input type="text" class="form-control rz-form-control" id="alertTitle" placeholder="Enter title here">
										    <span class="help-block rz-help-block">Max 30 characters here</span>
										  </div>							    
			
										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg revize-textarea" id="alertContent">
										    <label for="briefContent">Alert Brief<small></small></label>
										    <!-- replace with revize text editor and keep id="briefContent" -->
										    <textarea class="form-control form-control" id="briefContent" rows="10"></textarea>
										    <!-- replace with revize text editor and keep id="briefContent" -->					
										    <span class="help-block rz-help-block">Max 120 characters here</span>
										  </div>								     

										  <div class="form-group form-group-lg rz-form-group rz-form-group-lg revize-textarea" id="alertContent">
										    <label for="detailContent">Alert Detail<small></small></label>
										    <!-- replace with revize text editor and keep id="briefContent" -->
										    <textarea class="form-control form-control" id="detailContent" rows="10"></textarea>
										    <!-- replace with revize text editor and keep id="detailContent" -->										    
										  </div>								     
	...
	<%@ include file="/plugins/_editforms_/includes/alert-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/alert-editform/footer.jsp"%>