...
<%@ include file="/plugins/_editforms_/includes/banner-editform/header.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/banner-editform/tabs.jsp"%>
	...
	<%@ include file="/plugins/_editforms_/includes/banner-editform/tab-panels.jsp"%>
...
<%@ include file="/plugins/_editforms_/includes/banner-editform/footer.jsp"%>