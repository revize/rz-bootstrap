...
<main id="main">
	<div class="container">
		<article id="entry">
			...
			<h2 id="page-title">page title here</h2>
			<div id="post">
				...
				<img src="_assets_/images/placeholder-1.jpg" alt="placeholder image" style = "\">
				<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque. <b><u>Curabitur blandit tempus porttitor. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b></u> Vestibulum id ligula porta felis euismod semper. Sed posuere consectetur est at lobortis. Maecenas faucibus mollis interdum.</p>
				<ul>
